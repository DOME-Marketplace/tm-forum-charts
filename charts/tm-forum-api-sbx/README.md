...
![Version: 0.14.19](https://img.shields.io/badge/Version-0.14.19-informational?style=flat-square) ![AppVersion: 0.13.2](https://img.shields.io/badge/AppVersion-0.13.2-informational?style=flat-square)
...
| defaultConfig.image | object | `{"pullPolicy":"IfNotPresent","repository":"docker.io/drllbl18","tag":"sbx_1.4.3"}` | configuration to be used for the image of the container |
...
| defaultConfig.image.tag | string | `"sbx_1.4.3"` | tag to be used, most of the time the apis will use the same version |
